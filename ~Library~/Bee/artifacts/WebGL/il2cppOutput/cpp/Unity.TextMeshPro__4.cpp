...
IL_0034:
	{
		int32_t L_8 = V_0;
		if ((!(((uint32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_8, ((int32_t)36)))) > ((uint32_t)2))))
		{
			goto IL_003d;
		}
	}
...
IL_003d:
	{
		bool L_9 = __this->___m_HideSoftKeyboard;
		V_2 = L_9;
		goto IL_004a;
	}
...
IL_003d:
	{
		bool* L_9 = (bool*)(&__this->___m_HideSoftKeyboard);
		bool L_10 = ___0_value;
		bool L_11;
		L_11 = SetPropertyUtility_SetStruct_TisBoolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_mFC5853627DE5D7B57CA91271BE9B87C37468C5B0(L_9, L_10, SetPropertyUtility_SetStruct_TisBoolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_mFC5853627DE5D7B57CA91271BE9B87C37468C5B0_RuntimeMethod_var);
		goto IL_0055;
	}
...
IL_0055:
	...
	{
		bool L_14;
		L_14 = TouchScreenKeyboard_get_isSupported_mCFAC95CA6CAA06B4E21F42E3C40A39668D6B438E(NULL);
		if (!L_14)
		{
			goto IL_0079;
		}
...
IL_0075:
	...
	}
	{
		...
		bool L_13;
		L_13 = TouchScreenKeyboard_get_active_mB22402FB9E56D3F652DA785F01E504A530FF8775(L_12, NULL);
		G_B20_0 = ((((int32_t)L_13) == ((int32_t)0))? 1 : 0);
		goto IL_008e;
	}
...
IL_035f:
	{
		...
		V_30 = (bool)((!(((RuntimeObject*)(OnValidateInput_t88ECDC5C12A807AF2A5761369563B0FAA6A25530*)L_92) <= ((RuntimeObject*)(RuntimeObject*)NULL)))? 1 : 0);
		bool L_93 = V_30;
		if (!L_93)
		{
			goto IL_0390;
...
IL_0390:
	{
		...
		V_31 = (bool)((!(((uint32_t)L_100) <= ((uint32_t)0)))? 1 : 0);
		bool L_101 = V_31;
		if (!L_101)
		{
			goto IL_03ba;
...
IL_03ba:
	...
	{
		Il2CppChar L_108 = V_28;
		G_B89_0 = ((((int32_t)L_108) == ((int32_t)((int32_t)10)))? 1 : 0);
		goto IL_03cc;
	}
...
IL_03fa:
	...
	{
		int32_t L_113;
		L_113 = TMP_InputField_get_characterValidation_m57E36C62FC9E23DB17F440BA4325A314EF0B0679(__this, NULL);
		G_B94_0 = ((((int32_t)((((int32_t)L_113) == ((int32_t)8))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_040d;
	}
...
IL_040d:
	...
	{
		String_t* L_115 = __this->___m_Text;
		il2cpp_codegen_runtime_class_init_inline(il2cpp_defaults.char_class);
		String_t* L_116;
		L_116 = Char_ToString_m2A308731F9577C06AF3C0901234E2EAC8327410C((&V_28), NULL);
		String_t* L_117;
		L_117 = String_Concat_m9E3155FB84015C823606188F53B47CB44C444991(L_115, L_116, NULL);
		__this->___m_Text = L_117;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___m_Text), (void*)L_117);
	}

IL_042b:
	{
		int32_t L_118 = V_27;
		V_27 = ((int32_t)il2cpp_codegen_add(L_118, 1));
	}
...
IL_0432:
	{
		...
		V_34 = (bool)((((int32_t)L_119) < ((int32_t)L_121))? 1 : 0);
		bool L_122 = V_34;
		if (L_122)
		{
			goto IL_033c;
	...
	{
		int32_t L_123;
		L_123 = TMP_InputField_get_characterLimit_m59833E0A22BACBDF3EDA6A70A30B87272FBAA409(__this, NULL);
	...
	{
		String_t* L_124 = __this->___m_Text;
		int32_t L_125;
		...
		G_B101_0 = ((((int32_t)L_125) > ((int32_t)L_126))? 1 : 0);
		goto IL_0464;
	}
...
IL_0464:
	...
	{
		String_t* L_128 = __this->___m_Text;
		int32_t L_129;
		L_129 = TMP_InputField_get_characterLimit_m59833E0A22BACBDF3EDA6A70A30B87272FBAA409(__this, NULL);
		String_t* L_130;
		L_130 = String_Substring_mB1D94F47935D22E130FF2C01DBB6A4135FBB76CE(L_128, 0, L_129, NULL);
		__this->___m_Text = L_130;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___m_Text), (void*)L_130);
	}
...
IL_0482:
	{
		...
		String_t* L_132 = V_0;
		bool L_133;
		L_133 = String_op_Inequality_m8C940F3CFC42866709D7CA931B3D77B4BE94BCB6(L_131, L_132, NULL);
		V_36 = L_133;
		bool L_134 = V_36;
		if (!L_134)
		{
	...
	}
	{
		...
		String_t* L_136 = __this->___m_Text;
		TouchScreenKeyboard_set_text_m0A8AA05F4D9D27E8764955F0041452145B6C6FBB(L_135, L_136, NULL);
	}
...
IL_04bb:
	{
		bool L_137 = __this->___m_HideMobileInput;
		if (!L_137)
		{
			goto IL_04ee;
		}
	...
	}
	{
		...
		bool L_140;
		L_140 = TouchScreenKeyboard_get_canSetSelection_m6CD6C069A9FEF91CC8014B877EB057ECF598EDF9(L_139, NULL);
		if (!L_140)
		{
			goto IL_04ee;
		}
	}
	{
		il2cpp_codegen_runtime_class_init_inline(Application_tDB03BE91CDF0ACA614A5E0B67CFB77C44EB19B21_il2cpp_TypeInfo_var);
		int32_t L_141;
		L_141 = Application_get_platform_m59EF7D6155D18891B24767F83F388160B1FF2138(NULL);
	...
	}
	{
		il2cpp_codegen_runtime_class_init_inline(Application_tDB03BE91CDF0ACA614A5E0B67CFB77C44EB19B21_il2cpp_TypeInfo_var);
		int32_t L_142;
		L_142 = Application_get_platform_m59EF7D6155D18891B24767F83F388160B1FF2138(NULL);
		G_B113_0 = ((((int32_t)((((int32_t)L_142) == ((int32_t)((int32_t)31)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_04ef;
	}
...
IL_04ef:
	...
	{
		int32_t L_144;
		L_144 = TMP_InputField_get_caretSelectPositionInternal_m977002CC2C821A3B4FA5FB3F1BC15C7DD0BA35A4(__this, NULL);
		int32_t L_145;
		L_145 = TMP_InputField_get_caretPositionInternal_m21C9BFCD70C944B374E5C916C7E7E67B75B831EA(__this, NULL);
		int32_t L_146;
		L_146 = Mathf_Min_m888083F74FF5655778F0403BB5E9608BEFDEA8CB_inline(L_144, L_145, NULL);
		V_38 = L_146;
		int32_t L_147;
		...
		int32_t L_149;
		L_149 = Mathf_Abs_mD945EDDEA0D62D21BFDBAB7B1C0F18DFF1CEC905_inline(((int32_t)il2cpp_codegen_subtract(L_147, L_148)), NULL);
		V_39 = L_149;
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_150 = __this->___m_SoftKeyboard;
		int32_t L_151 = V_38;
		int32_t L_152 = V_39;
		RangeInt_tDFBE4FD13857C11F21F7C3DA6B60D05341B67268 L_153;
		memset((&L_153), 0, sizeof(L_153));
		RangeInt__ctor_m3CB91E79C7B5AED97E564581025B2F66778B7CBE((&L_153), L_151, L_152, NULL);
		TouchScreenKeyboard_set_selection_mC27C2948118086822A151118C379FAAF692DB2DF(L_150, L_153, NULL);
		goto IL_057c;
	}

IL_0535:
	{
		bool L_154 = __this->___m_HideMobileInput;
		if (!L_154)
		{
			goto IL_0546;
		}
	}
	{
		il2cpp_codegen_runtime_class_init_inline(Application_tDB03BE91CDF0ACA614A5E0B67CFB77C44EB19B21_il2cpp_TypeInfo_var);
		int32_t L_155;
		L_155 = Application_get_platform_m59EF7D6155D18891B24767F83F388160B1FF2138(NULL);
		if ((((int32_t)L_155) == ((int32_t)((int32_t)11))))
		{
			goto IL_056c;
		}
	}
...
IL_0546:
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_156 = __this->___m_SoftKeyboard;
		bool L_157;
		L_157 = TouchScreenKeyboard_get_canSetSelection_m6CD6C069A9FEF91CC8014B877EB057ECF598EDF9(L_156, NULL);
		if (!L_157)
		{
			goto IL_0569;
		}
	...
	}
	{
		il2cpp_codegen_runtime_class_init_inline(Application_tDB03BE91CDF0ACA614A5E0B67CFB77C44EB19B21_il2cpp_TypeInfo_var);
		int32_t L_159;
		L_159 = Application_get_platform_m59EF7D6155D18891B24767F83F388160B1FF2138(NULL);
		G_B121_0 = ((((int32_t)L_159) == ((int32_t)((int32_t)31)))? 1 : 0);
		goto IL_0567;
	}
...
IL_057c:
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_161 = __this->___m_SoftKeyboard;
		if (!L_161)
		{
			goto IL_0594;
		}
	...
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_162 = __this->___m_SoftKeyboard;
		int32_t L_163;
		L_163 = TouchScreenKeyboard_get_status_mCC466FDEC7E1913D8585ABA7F048FC198CB19504(L_162, NULL);
		G_B130_0 = ((!(((uint32_t)L_163) <= ((uint32_t)0)))? 1 : 0);
		goto IL_0595;
	}
...
IL_0595:
	...
	}
	{
		...
		V_42 = (bool)((((int32_t)L_166) == ((int32_t)2))? 1 : 0);
		bool L_167 = V_42;
		if (!L_167)
		{
			goto IL_05b7;
...
IL_02aa:
	{
		...
		V_16 = L_57;
		TMP_TextInfo_t09A8E906329422C3F0C059876801DD695B8D524D* L_58 = V_16;
		if (!L_58)
		{
			goto IL_02d0;
		}
	}
	{
		...
		int32_t L_60 = L_59->___lineCount;
		int32_t L_61 = __this->___m_LineLimit;
		G_B61_0 = ((((int32_t)((((int32_t)L_60) < ((int32_t)L_61))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_02d1;
	}
...
IL_0301:
	{
		Event_tEBC6F24B56CE22B9C9AD1AC6C24A6B83BC3860CB* L_63 = ___0_evt;
		Il2CppChar L_64;
		L_64 = Event_get_character_m8F7A92E90EF65B9379C01432B42D6BF818C32A61(L_63, NULL);
		V_5 = L_64;
		bool L_65;
		L_65 = TMP_InputField_get_multiLine_m3000150A39B90BCFFAFD41E0F49F479323F045B7(__this, NULL);
		if (L_65)
		{
			goto IL_0328;
		}
	...
	{
		Il2CppChar L_68 = V_5;
		G_B70_0 = ((((int32_t)L_68) == ((int32_t)((int32_t)10)))? 1 : 0);
		goto IL_0326;
	}
...
IL_0334:
	{
		Il2CppChar L_70 = V_5;
		if ((((int32_t)L_70) == ((int32_t)((int32_t)13))))
		{
			goto IL_0341;
		}
	}
	{
		Il2CppChar L_71 = V_5;
		G_B77_0 = ((((int32_t)L_71) == ((int32_t)3))? 1 : 0);
		goto IL_0342;
	}
...
IL_034c:
	...
	{
		Il2CppChar L_74 = V_5;
		G_B82_0 = ((((int32_t)L_74) == ((int32_t)((int32_t)10)))? 1 : 0);
		goto IL_0358;
	}
...
IL_0362:
	{
		Il2CppChar L_76 = V_5;
		bool L_77;
		L_77 = VirtualFuncInvoker1< bool, Il2CppChar >::Invoke(67, __this, L_76);
		V_21 = L_77;
		bool L_78 = V_21;
		if (!L_78)
		{
	...
	{
		Il2CppChar L_79 = V_5;
		VirtualActionInvoker1< Il2CppChar >::Invoke(71, __this, L_79);
	}

IL_037b:
	{
		Il2CppChar L_80 = V_5;
		V_22 = (bool)((((int32_t)L_80) == ((int32_t)0))? 1 : 0);
		bool L_81 = V_22;
		if (!L_81)
		{
			goto IL_03a0;
	...
	{
		int32_t L_82;
		L_82 = TMP_InputField_get_compositionLength_m444E57B7F68C9AECE1CDEBF4732FAD66EBA4937F(__this, NULL);
...
IL_0247:
	...
	{
		bool L_90 = __this->___m_isLastKeyBackspace;
...
IL_026d:
	{
		...
		int32_t L_108;
		L_108 = FaceInfo_get_pointSize_m7EF7429A4725AB715931A220F6BB498C3D6BF7CB(L_107, NULL);
		...
		V_7 = ((float)il2cpp_codegen_multiply(((float)(L_105/((float)L_108))), L_111));
...
IL_0068:
	...
	}
	{
		...
		bool L_18;
		L_18 = VirtualFuncInvoker0< bool >::Invoke(28, L_17);
